jQuery(document).ready(function() {
    ...
    var piedata = [
        ...
        { label: "Series 2", data: [[1,30]], color: '#E56825'},
   ...
   var m6 = new Morris.Donut({
        ...
        colors: ['#D9534F','#E56825','#428BCA','#5BC0DE','#428BCA']
   });
    ...
    jQuery('#sparkline3').sparkline([4,3,3,1,4,3,2,2,3], {
		  type: 'pie', 
		  height:'33px',
        sliceColors: ['#F0AD4E','#428BCA','#D9534F','#E56825','#5BC0DE']
    });
