...
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'tls';
$mail->Subject = mb_strtoupper($nomeFantasiaCliente) . ' - Faturas Agrupadas';
$mail->Username = USERMAIL;
$mail->WordWrap = 50;
$mensagemTopo = "
<html>
<head>
    <title>Faturas " . ' ' . $cliente->getRazaoSocial() . "</title>
            ...
            <td align='left'>
                <table width='100%' border='0' cellspacing='4' cellpadding='2'>
                    ...
                    <tr>
                        ...
                        <td align='center' class='campos'>" . $valor->getVencimento() . "</td>
                    </tr>
                </table>
            </td>
        </tr>
...
$mail->Body = $mensagemTopo . $mensagem . $mensagemRodape;
$pessoas = new Pessoa();
...
if (!$mail->send()) {
    ...
    foreach($grupo as $chave => $valor) {
        $fatura->logFaturaHistorico( $idUsuario, $valor->getId(), 'A' );
    }
}
?>
